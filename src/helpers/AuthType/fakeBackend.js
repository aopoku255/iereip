...
const todayDeviceData = [];
const lastWeekDeviceData = [];
const lastMonthDeviceData = [];
const currentYearDeviceData = [];
...
const btcPortfolioData = [];
const usdPortfolioData = [];
const euroPortfolioData = [];
