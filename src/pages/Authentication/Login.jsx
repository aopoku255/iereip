                ...
                <div className="auth-page-content">
                    <Container>
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/" className="d-inline-flex align-items-center gap-2 auth-logo rounded-pill bg-white/10 px-3 py-2 shadow-sm text-decoration-none">
                                            <img src={logoLight} alt="IEREIP logo" height="40" />
                                            <span className="fw-semibold text-white">IEREIP Enterprise</span>
                                        </Link>
                                    </div>
                                    <p className="mt-3 mb-0 fs-15 text-white-50">Secure access to your finance, loans, and operations workspace.</p>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4 border-0 shadow-lg rounded-4 overflow-hidden" style={{ background: 'linear-gradient(145deg, #ffffff 0%, #f9fbff 100%)' }}>
                                    <CardBody className="p-4 p-lg-5">
                                        <div className="text-center mb-4">
                                            ...
                                            <p className="text-muted mb-0">Sign in to continue to your IEREIP workspace.</p>
                                        </div>
                                        {error && error ? (<Alert color="danger" className="rounded-3"> {error} </Alert>) : null}
                                        <div className="p-2 mt-3">
                                            <Form
                                                ...
                                                <div className="mt-4 pt-2 border-top">
                                                    <div className="d-flex flex-wrap gap-2 justify-content-center text-muted small">
