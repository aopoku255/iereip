...
const BasicSignIn = () => {
    ...
    document.title = "Basic SignIn | IEREIP Enterprice";
                                ...
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted"> Sign in to continue to IEREIP.</p>
                                        </div>
                                            ...
                                            <form action="#">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <div className="position-relative auth-pass-inputgroup mb-3">
                                                        <Input type={passwordShow ? "text" : "password"} className="form-control pe-5 password-input" placeholder="Enter password" id="password-input" required/>
