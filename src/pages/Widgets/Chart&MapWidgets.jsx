                        ...
                        <CardBody className="p-0">
                            <div>
                                <div id="countries_charts" className="apex-charts" dir="ltr">
                                    ...
                                    <SessionsByCountriesCharts dataColors='["--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-info", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary"]' />
                                </div>
                            </div>
                        </CardBody>
                    </Card>
                ...
                <Col xxl={4}>
                    <Card className="card-height-100">
                        ...
                        <CardHeader className="p-0">
                            <Alert color="primary" className="alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
                        ...
                        <CardBody className="p-0 pb-2">
                            <div>
                                <div id="audiences_metrics_charts" className="apex-charts" dir="ltr">
                                    ...
                                    <AudiencesMetricsCharts dataColors='["--vz-primary", "--vz-light"]' />
                                </div>
                            </div>
                        </CardBody>
                    </Card>
                    ...
                    <Card className="card-height-100">
                        ...
                        <CardBody>
                            <div id="color_heatmap" className="apex-charts mt-n3" dir="ltr">
                                ...
                                <TopReferralsPagesCharts dataColors='["--vz-info", "--vz-success", "--vz-primary", "--vz-warning", "--vz-secondary"]' />
                            </div>
