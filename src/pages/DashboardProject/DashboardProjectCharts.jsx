...
const LoansStatusChart = ({ dataColors, series }) => {
    var donutchartLoansStatusColors = getChartColorsArray(dataColors);
    
    var options = {
        labels: ["Active", "Pending Approval", "Closed"],
        chart: {
            type: "donut",
            height: 230,
        },
        ...
        colors: donutchartLoansStatusColors,
    };
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr"
...
export { ProjectsOverviewCharts, TeamMembersCharts, PrjectsStatusCharts, LoansStatusChart };