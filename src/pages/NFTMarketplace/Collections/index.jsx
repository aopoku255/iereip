...
const Collections = () => {
    document.title = "Collections | IEREIP Enterprice";
    return (
        <React.Fragment>
                        ...
                        {topCollection.map((item, key) => (<Col xl={3} md={4} sm={6} key={key}>
                            <Card>
                                <CardBody>
                                    ...
                                    <h5 className="mb-0 fs-15"><Link to="#!" className="text-dark">{item.category} <span className="badge bg-primary-subtle text-primary">{item.quantity}</span></Link></h5>
                                </CardBody>
                            </Card>
                        </Col>))}
                    </Row>
