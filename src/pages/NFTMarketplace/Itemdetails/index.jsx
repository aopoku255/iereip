...
const ItemDetails = () => {
    document.title = "Item Details | IEREIP Enterprice";
                                ...
                                <Col lg={8}>
                                    <div>
                                        ...
                                        <div className="hstack gap-3 flex-wrap">
                                            ...
                                            <div className="text-muted">Seller : <span className="text-dark fw-medium">Rickey Teran</span></div>
                                            <div className="vr"></div>
                                            <div className="text-muted">Published : <span className="text-dark fw-medium">29 April, 2022</span></div>
                                        </div>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="text-dark"><span className="mb-0 ms-2">Brave Tigers NFT</span></Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>0.235 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="text-dark"><span className="mb-0 ms-2">Creative filtered portrait</span></Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>571.24 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="text-dark"><span className="mb-0 ms-2">Evolved Reality</span></Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>130.39 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="text-dark"><span className="mb-0 ms-2">Robotic Body Art</span></Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>81.72 ETH</td>
                                                                    <td>
                                                                ...
                                                                <li className="py-2">
                                                                    <div className="border border-dashed rounded p-3">
                                                                        ...
                                                                        <div className="hstack gap-3">
                                                                                ...
                                                                                <div className="vr"></div>
                                                                                <div className="flex-grow-1">
                                                                                    <p className="text-muted mb-0"> Superb Artwork.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
