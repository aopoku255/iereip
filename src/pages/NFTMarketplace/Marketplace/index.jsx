...
const Marketplace = () => {
    document.title = "Marketplace | IEREIP Enterprice";
                ...
                <Container fluid>
                                ...
                                {marketPlacewidget.map((item, key) => (<Col lg={4} md={6} key={key}>
                                    <Card>
                                        <CardBody>
                                            ...
                                            <h5 className="mb-0 fs-15"><Link to="#!" className="text-dark">{item.category} <span className="badge bg-success-subtle text-success">{item.quantity}</span></Link></h5>
                                        </CardBody>
                                    </Card>
                                </Col>))}
                            </Row>
                        ...
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                <div className="flex-grow-1">
                                    <h5 className="card-title mb-0 fw-bold fs-16">Trending Artwork</h5>
                                </div>
                                    ...
                                    <CardBody>
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <h6 className="mb-1 fs-15">{item.author}</h6>
                                                <p className="mb-0 fs-14 text-muted">{item.title}</p>
                                            </div>
                                        ...
                                        <div className="explore-place-bid-img overflow-hidden rounded">
                                            ...
                                            <div className="place-bid-btn">
                                                <Link to="#!" className="btn btn-primary"><i className="ri-auction-fill align-bottom me-1"></i> Place Bid</Link>
                                            </div>
                                        </div>
                                        <div className="mt-3">
                                            <p className="fw-medium mb-0 float-end"><i className="mdi mdi-heart text-danger align-middle"></i> {item.likes} </p>
                                            <h5 className="text-primary"><i className="mdi mdi-ethereum"></i> {item.price} </h5>
                                            <h6 className="fs-15 mb-0"><Link to="/apps-nft-item-details" className="text-dark">{item.category}</Link></h6>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                <div className="flex-grow-1">
                                    <h5 className="card-title mb-0 fw-bold fs-16">Recent NFTs Artwork</h5>
                                </div>
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                        ...
                        {nftArtworkData.map((item, key) => (
                            <Col key={key}>
                                <Card className="explore-box card-animate">
                                    ...
                                    <CardBody>
                                        <p className="fw-medium mb-0 float-end"><i className="mdi mdi-heart text-danger align-middle"></i> {item.likes} </p>
                                        <h5 className="mb-1 fs-15"><Link to="/apps-nft-item-details" className="text-body">{item.title}</Link></h5>
                                        <p className="text-muted fs-14 mb-0">{item.category}</p>
                                    </CardBody>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <CardBody className="text-center">
                                        ...
                                        <h5 className="mt-3 mb-1 fs-15"><Link to="#!" className="text-body">{item.author}</Link></h5>
