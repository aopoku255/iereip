...
const LiveAuction = () => {
    document.title = "Live Auction | IEREIP Enterprice";
                                ...
                                {(aution.filter(({ category }) => displayCategory === category || displayCategory === "All")).map((item, key) => (<Col xxl={3} lg={4} md={6} className="product-item upto-15" key={key}>
                                    <Card className="explore-box card-animate">
                                        ...
                                        <CardBody>
                                            ...
                                            <h5 className="text-primary"><i className="mdi mdi-ethereum"></i> {item.price} ETH </h5>
                                            <h6 className="fs-15 mb-3"><Link to="/apps-nft-item-details" className="text-dark">{item.title}</Link></h6>
                                            <div>
