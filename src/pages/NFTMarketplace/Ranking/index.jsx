...
const Ranking = () => {
    document.title = "Ranking | IEREIP Enterprice";
        ...
        () => [
            {
                ...
                Cell: (cell) => {
                    if (cell.value < 4) {
                        return (<div className="ranking text-danger fw-semibold">#{cell.value}</div>);
                    } else {
                    ...
                    <>
                        <div className="collection">
                            <div className="d-flex align-items-center">
                                <img src={collection.row.original.img} alt="" className="avatar-xs rounded-circle object-fit-cover me-2" /> <Link to="/apps-nft-item-details" className="text-dark">{collection.row.original.collection}</Link>
                            </div>
                        </div>
                    </>
                ),
