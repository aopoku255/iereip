...
const Creators = () => {
    document.title = "Creators | IEREIP Enterprice";
    return (
        <React.Fragment>
                ...
                <Container fluid>
                    ...
                    <Row className="g-4 mb-3">
                        <Col className="col-sm-auto">
                            <div>
                                <Link to="/apps-projects-create" className="btn btn-primary"><i className="ri-add-line align-bottom me-1"></i> Add New</Link>
                            </div>
                        </Col>
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <Link to="/pages-profile">
                                                    <h5 className="mb-1 fs-15">{item.title}</h5>
                                                </Link>
                                                <p className="text-muted mb-0 fs-14"><i className="mdi mdi-ethereum text-primary fs-14"></i> {item.price}</p>
                                            </div>
                                            <div>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <Link to="/pages-profile">
                                            <h5 className="mt-2 mb-1 fs-15">{item.title}</h5>
                                        </Link>
                                        <p className="text-muted mb-2 fs-14">{item.products} Products</p>
                                        <p className="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                                        <button className={item.isFollowBtn ? "btn btn-secondary w-100" : "btn btn-soft-primary w-100"}>{item.isFollowBtn ? "Follow" : "UnFollow"} </button>
                                    </div>
                                </Card>
                            </Col>
                        ))}
