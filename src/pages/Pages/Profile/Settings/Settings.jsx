...
const Settings = () => {
    ...
    const [text, setText] = useState("Hi I'm Anna Adame, It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family.");
    ...
    document.title = "Profile Settings | IEREIP Enterprice";
    return (
        <React.Fragment>
                                                ...
                                                <Row>
                                                    ...
                                                    <Col lg={12}>
                                                        <div className="hstack gap-2 justify-content-end">
                                                            ...
                                                            <button type="button"
                                                                className="btn btn-soft-secondary">Cancel</button>
                                                        </div>
                                                    </Col>
                                                </Row>
                                            </Form>
                                            ...
                                            <form>
                                                            ...
                                                            <Col lg={12}>
                                                                <div className="mb-3">
                                                                    <Label htmlFor="jobDescription" className="form-label">Job
                                                                        Description</Label>
                                                                    <textarea className="form-control" id="jobDescription" rows="3" placeholder="Enter description" value={textExperience}
                                                ...
                                                <Col lg={12}>
                                                    <div className="hstack gap-2">
                                                        <button type="submit" className="btn btn-success" onClick={e => e.preventDefault()}>Update</button>
                                        ...
                                        <TabPane tabId="4">
                                            ...
                                            <div>
                                                ...
                                                <div className="hstack gap-2 mt-3">
                                                    <Link to="#" className="btn btn-soft-primary">Close &
