...
const SimplePage = () => {
    ...
    document.title = "Profile | IEREIP Enterprice";
    return (
        <React.Fragment>
                                            ...
                                            <Col xxl={3}>
                                                <Card>
                                                    <CardBody>
                                                        ...
                                                        <Progress value={30} color="primary" className="animated-progess custom-progress progress-label" ><div className="label">30%</div> </Progress>
                                                    </CardBody>
                                                </Card>
                                                    ...
                                                    <CardBody>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2">
                                                            ...
                                                            <div>
                                                                <Link to="#" className="avatar-xs d-block">
                                                                    <span
                                                                        className="avatar-title rounded-circle fs-16 bg-danger-subtle text-danger">
                                                            ...
                                                            <div>
                                                                <Link to="#" className="avatar-xs d-block">
                                                                    <span
                                                                        className="avatar-title rounded-circle fs-16 bg-success-subtle text-success">
                                                ...
                                                <Card>
                                                    <CardBody>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2 fs-15">
                                                            <Link to="#"
                                                                className="badge bg-secondary-subtle text-secondary">Photoshop</Link>
                                                            <Link to="#"
                                                                className="badge bg-secondary-subtle text-secondary">illustrator</Link>
                                                            <Link to="#"
                                                            ...
                                                            <Link to="#"
                                                                className="badge bg-secondary-subtle text-secondary">Php</Link>
                                                            <Link to="#"
                                                                className="badge bg-secondary-subtle text-secondary">Python</Link>
                                                        </div>
                                                    </CardBody>
                                                </Card>
                                                        ...
                                                        <div>
                                                            <div className="d-flex align-items-center py-3">
                                                                ...
                                                                <div className="flex-shrink-0 ms-2">
                                                                    <button type="button"
                                                                        className="btn btn-sm btn-outline-secondary"><i
                                                                                                ...
                                                                                                <div className="col-auto">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <i
                                                                                                                className="ri-image-2-line fs-17 text-secondary"></i>
                                                                                                        </div>
                                                                                                        <div
                                                                                                ...
                                                                                                <div className="col-auto">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            className="flex-shrink-0">
                                                                                                            <i
                                                                                                                className="ri-file-zip-line fs-17 text-secondary"></i>
                                                                                                        </div>
                                                                                                        <div
                                                                                                            className="flex-grow-1 ms-2">
                                                                                                            <h6><Link to="#"
                                                    ...
                                                    <CardBody>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="swiper-wrapper">
                                                                <SwiperSlide>
                                                                    <Card
                                                                        className="profile-project-card shadow-none profile-project-primary mb-0">
                                                                ...
                                                                <SwiperSlide>
                                                                    <Card className="profile-project-card shadow-none profile-project-primary mb-0">
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                            ...
                                            <CardBody>
                                                ...
                                                <div className="Activity-timeline">
                                                    <div className="Activity-item d-flex">
                                                        <div className="flex-shrink-0">
                                                            <img src={avatar1} alt="" className="avatar-xs rounded-circle Activity-avatar" />
                                                        </div>
                                                    ...
                                                    <div className="Activity-item py-3 d-flex">
                                                        <div className="flex-shrink-0">
                                                            <img src={avatar2} alt="" className="avatar-xs rounded-circle Activity-avatar" />
                                                        </div>
                                                        <div className="flex-grow-1 ms-3">
                                                    ...
                                                    <div className="Activity-item py-3 d-flex">
                                                        <div className="flex-shrink-0">
                                                            <img src={avatar6} alt="" className="avatar-xs rounded-circle Activity-avatar" />
                                                        </div>
                                                        <div className="flex-grow-1 ms-3">
                                                    ...
                                                    <div className="Activity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2"><span className="text-danger">2 days
                                                                ...
                                                                report. <Link to="#" className="link-primary text-decoration-underline">Reports
                                                                    Builder</Link></p>
                                                                            ...
                                                                            <td>
                                                                                <div className="d-flex align-items-center">
                                                                                    <div className="avatar-sm">
                                                                                        <div
                                                                                             className={`avatar-title bg-light text-primary rounded fs-20`}>
                                                                                            <i className={item.icon}></i>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div className="ms-3 flex-grow-1">
                                                                                        <h6 className="fs-15 mb-0"><Link to="#" className="link-secondary">{item.fileName}</Link>
                                                                                        </h6>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
