...
const SearchResults = () => {
    ...
    document.title = "Search Results | IEREIP Enterprice";
    return (
        <React.Fragment>
                        ...
                        <Col lg={12}>
                            <Card>
                                <CardHeader className="border-0">
                                    ...
                                    >
                                        <OffcanvasBody>
                                            <button onClick={() => setIsOpen(false)} type="button" className="btn-close text-reset float-end" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                    ...
                                    <Nav className="nav-tabs nav-tabs-custom" role="tablist">
                                        ...
                                        <li className="nav-item ms-auto">
                                            <Dropdown isOpen={dropdownOpen} toggle={toggledropDown} >
                                                <DropdownToggle tag="a" className="nav-link fw-medium text-reset mb-n1" role="button">
                                                            ...
                                                            <Card className="gallery-box">
                                                                ...
                                                                <div className="box-content">
                                                                    <div className="d-flex align-items-center mt-2">
                                                                        <div className="flex-grow-1 text-muted">by <Link to="" className="text-dark text-truncate">{item.auther}</Link></div>
                                                                        <div className="flex-shrink-0">
                                                                            <div className="d-flex gap-3">
                                                                                <button type="button" className="btn btn-sm fs-12 btn-link text-dark text-decoration-none px-0">
                                                                ...
                                                                <div className="d-sm-flex">
                                                                    ...
                                                                    <div className="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                        <ul className="list-inline mb-2">
                                                                            <li className="list-inline-item"><span className={`badge bg-${item.badgeClass}-subtle fs-11 text-${item.badgeClass}`}>{item.badgeText}</span></li>
                                                                        </ul>
