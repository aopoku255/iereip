...
const Team = () => {
    document.title = "Team | IEREIP Enterprice";
                            ...
                            <Row className="g-2">
                                ...
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        ...
                                        <Button color="info" id="grid-view-button" className="btn btn-soft-primary nav-link btn-icon fs-14 active filter-button"><i className="ri-grid-fill"></i></Button>
                                        <Button color="primary" id="list-view-button" className="btn btn-soft-primary nav-link  btn-icon fs-14 filter-button"><i className="ri-list-unordered"></i></Button>
                                        <Dropdown
                                            isOpen={dropdownOpen}
                                            toggle={toggledropDown}>
                                            <DropdownToggle type="button" color='soft-info' className="btn-icon fs-14">
                                ...
                                <Row className="team-list grid-view-filter">
                                    ...
                                    <Col lg={12}>
                                        <div className="text-center mb-3">
                                            <Link to="#" className="text-primary"><i className="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load More </Link>
                                        </div>
                                    </Col>
                                </Row>
                                                                    ...
                                                                    <div className="d-flex position-absolute start-0 end-0 top-0 p-3">
                                                                        ...
                                                                        <div className="flex-shrink-0">
                                                                            <div className="d-flex gap-3 align-items-center">
                                                                                ...
                                                                                <button onClick={() => setModal(false)} type="button" className="btn-close btn-close-white" id="createMemberBtn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <OffcanvasBody className="profile-offcanvas p-0">
                                        ...
                                        <div className="p-3 text-center">
                                            ...
                                            <div className="hstack gap-2 justify-content-center mt-4">
                                                ...
                                                <div className="avatar-xs">
                                                    <Link to="#" className="avatar-title bg-primary-subtle text-primary rounded fs-16">
                                        ...
                                        <div className="p-3 border-top">
                                            ...
                                            <div className="d-flex mb-3">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h6 className="mb-1"><Link to="#" className="link-secondary">Images</Link></h6>
                                            ...
                                            <div className="d-flex mb-3">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h6 className="mb-1"><Link to="#" className="link-secondary">Documents</Link></h6>
                                            ...
                                            <div className="d-flex mb-3">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h6 className="mb-1"><Link to="#" className="link-secondary">Media</Link></h6>
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h6 className="mb-1"><Link to="#" className="link-secondary">Others</Link></h6>
