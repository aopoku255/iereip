...
const Pricing = () => {
    ...
    document.title = "Pricing | IEREIP Enterprice";
    return (
        <React.Fragment>
                        ...
                        {(pricing1 || []).map((price1, key) => (
                            <Col xxl={3} lg={6} key={key}>
                                ...
                                <Card className="pricing-box ribbon-box right" >
                                    {price1.ribbon === true ? <div className="ribbon-two ribbon-two-success"><span>Popular</span></div> : ""}
                        ...
                        <Col xl={9}>
                            <Row>
                                {(pricing2 || []).map((price2, key) => (
                                    <Col lg={4} key={key}>
                                        <Card className="pricing-box ribbon-box right">
                                            {price2.ribbon === true ? <div className="ribbon-two ribbon-two-success"><span>Popular</span></div> : ""}
                                                    ...
                                                    <ul className="list-unstyled text-muted vstack gap-3">
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    {price2.projectsUpto}  <b>{price2.projects}</b> Projects
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    {price2.CustomersUpto} <b>{price2.Customers}</b> Customers
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li>
